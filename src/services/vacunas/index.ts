...
import { createVacunaPacient, getCalendarioGeneral, getNameVacunas, getMisVacunas, getMisVacunasByHistory, getMiCalendario, deleteVacunaPacient } from './controller';
